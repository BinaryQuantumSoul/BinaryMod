...
public class BlockInit
{
    ...
    public static final RegistryObject<Block> TROJAN = BLOCKS.register("trojan", () -> new TrojanBlock(MALWARE));
    public static final RegistryObject<Block> KEY_LOGGER = BLOCKS.register("key_logger", () -> new KeyLoggerBlock(MALWARE));
