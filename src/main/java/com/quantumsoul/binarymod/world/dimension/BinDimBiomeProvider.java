...
//{
//    private static final List<Biome> biomes = ImmutableList.of(BiomeInit.BINARY_BIOME.get(), BiomeInit.HEX_BIOME.get(), BiomeInit.VOID_BIOME.get(), BiomeInit.WIRE_BIOME.get());
//
...
//    {
//        super(biomes);
//        this.genBiomes = makeTheWorld(((ServerWorld)world).getSeed());
...
//    {
//        return this.genBiomes.func_242936_a(WorldGenRegistries.BIOME, x, z);
//        //todo check
//    }
//
//    //BIOMES SIZE
